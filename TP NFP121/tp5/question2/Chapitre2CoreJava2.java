...
public class Chapitre2CoreJava2 {
	 ...
	 * 
	 * 2 méthodes utilitaires (statique) qui permettent de récupérer une liste de
	 * tokens issues d'une chaine de caractères et calculer le nombre d'occurrence
	 * des tokens de cette liste.
	 * 
	 **/
	public static List<String> listeDesMots() {
		...
		// Ajout des Tokens dans la liste
	...
	/**
	 * Obtention d'une liste de couples <String,Integer>. A chaque mot présent dans
	 * la liste, est associée à son nombre d'occurrence.
	 * 
	...
	public static Map<String, Integer> occurrencesDesMots(List<String> liste) {
		...
		// En lecture uniquement donc pas de soucis
		Iterator<String> iter = liste.iterator();

		// Je compare les 2 listes et stocke le couple clé (String) et valeur
		// (occurrence) dans la Map.
